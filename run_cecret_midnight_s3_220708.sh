...
#useage:
# bash run_cecret_midnight_s3_<date updated>.sh <sequencing_run> 
# Date updated: 2022-04-04
# changes: updated to accomodate changes to pangolin v4
#example############################################
...
#run cecret
/work/software/nextflow run $basedir/Cecret/Cecret_DSHS_midnight_pango_v4.1plus_usher.nf -c $basedir/Cecret/configs/docker.config
#rename sumamry file
