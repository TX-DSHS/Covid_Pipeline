...
/work/software/nextflow run /home/bioinform/Cecret/Cecret_DSHS_midnight_pango_v4.1plus_usher.nf -c /home/bioinform/Cecret/configs/docker.config 2>$basedir/run_Cecret.err
#rename sumamry file
...
python3 /work/software/code/summarize_cecret.py 2>>$basedir/run_Cecret.err  #script from Anna at UT Austin to summarize cecret results
#cp /work/software/code/parse_nextstrain_mutations.py ./
python3 /work/software/code/parse_nextstrain_mutations.py 2>>$basedir/run_Cecret.err #script from Anna at UT Austin to create list of mutations
