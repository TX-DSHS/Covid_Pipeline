...
params.primer_bed = workflow.projectDir + "/configs/QIAseqDIRECTSARSCoV2primersfinal.bed"
params.amplicon_bed = workflow.projectDir + "/configs/qiaseq-amplicons_edit.bed"
