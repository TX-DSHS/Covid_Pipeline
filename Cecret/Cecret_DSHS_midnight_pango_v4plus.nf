...
params.primer_bed = workflow.projectDir + "/configs/midnight_primers.bed"
params.amplicon_bed = workflow.projectDir + "/configs/midnight_amplicon.bed"
...
params.kraken2 = true
params.kraken2_db = '/work/software/kraken2/minikraken_8GB_20200312/'
...
params.ivar_minimum_read_depth = 30
...
process samtools_ampliconstats {
  ...
  '''
    ...
    samtools ampliconstats !{params.samtools_ampliconstats_options} -l 1300 \
      !{primer_bed} \
      !{bam} \
...
params.pangolin_options = '--analysis-mode pangolearn'
process pangolin {
  publishDir "${params.outdir}", mode: 'copy'
  tag "${sample}"
  echo false
  ...
  '''
    ...
    pangolin --pangolin-data-version>> $log_file
